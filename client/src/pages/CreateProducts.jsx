      ...
      <div class="min-h-screen flex flex-col">
                <div class="container px-10 py-20 flex flex-grow">
                    ...
                    <main class="w-3/4 bg-white p-8 shadow ml-4">
                        ...
                        <form autocomplete="off" action="" method="" enctype="multipart/form-data" onSubmit={handleSubmit}>
                            <div class="mb-6">
                                <h3 class="text-lg font-semibold mb-2">Product Details</h3>
                                <div class="mb-4">
                                    <label class="block mb-2 font-medium">Product Image</label>
                                    <input name="image" type="file" class="py-2 px-4 rounded" value={form.image} onChange={handleChange}/>
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <input name="name" type="text" placeholder="Product Name"
                                        class="border p-2 rounded w-full" value={form.name} onChange={handleChange}/>
                                    <input name="price" type="text" placeholder="Product Price"
                                        class="border p-2 rounded w-full" value={form.price} onChange={handleChange}/>
                                    <input name="discount" type="text" placeholder="Discount Price"
                                        class="border p-2 rounded w-full" value={form.discount} onChange={handleChange}/>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <input name="bgcolor" type="text" placeholder="Background Color"
                                        class="border p-2 rounded w-full" value={form.bgcolor} onChange={handleChange}/>
                                    <input name="panelcolor" type="text" placeholder="Panel Color"
                                        class="border p-2 rounded w-full" value={form.panelcolor} onChange={handleChange}/>
                                    <input name="textcolor" type="text" placeholder="Text Color"
                                        class="border p-2 rounded w-full" value={form.textcolor} onChange={handleChange}/>
                                </div>
                            </div>
